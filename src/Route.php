...
abstract class Route extends Main\Root implements Main\Contract\Meta
{
	...
	// static
	protected static $context = null; // conserve le context de la route
	...
	abstract public function run(bool $echo=false):array;	
	...
	abstract public function title($pattern=null,?string $lang=null,?array $option=null):?string;
	

	// allowed
	// retourne vrai si le role de la session courante permet d'accéder à la route
	abstract public static function allowed(?Main\Role $role=null):bool;
	
	
	// label
	// retourne le label de la route non triggé
	abstract public static function label($pattern=null,?string $lang=null,?array $option=null):?string;
	
	
	// description
	// retourne la description de la route non triggé
	abstract public static function description($pattern=null,?array $replace=null,?string $lang=null,?array $option=null):?string;
	...
	abstract public static function context(?array $option=null):array;
	...
	abstract public static function childs(bool $active=false):Routes;
	
	
	// make
	// construit une instance de la route de façon statique
	abstract public static function make($request=null,bool $overload=false):self;
	
	
	// makeOverload
	// construit une instance de la route de façon statique
	abstract public static function makeOverload($request=null):self;
	
	
	// makeParent
	// retourne une instance la route parente
	abstract public static function makeParent($request=null,bool $overload=false):self;
	
	
	// makeParentOverload
	// comme makeParent mais overload est à true
	abstract public static function makeParentOverload($request=null):self;
	...
	abstract public static function getTimeoutObject():Main\Timeout;
	...
	abstract public static function setType(string $value,bool $dig=false):void;
